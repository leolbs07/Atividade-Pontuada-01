...
def cliente_valido():
    ...
    cliente = Cliente(123, "Leandro", "71 98472 - 9798", "leandro@gmail.com", endereco_cliente, Sexo.MASCULINO, EstadoCivil.SOLTEIRO, "25/03/2007", "123_PA")
    print(cliente)

def ps_valido():
    limpar()
    endereco_ps = Endereco("Avenida Paulista", "1578", "9º Andar", "01310-200", "São Paulo", UnidadeFederativa.SAO_PAULO)
    ps = PrestacaoServico(321, "Leandro", "4002 - 8922", "leandro123@gmail.com", endereco_ps, "12.123.123/000", "SEFAZ", "25/03/2007", "Pendente...")
    print(ps)
...
def fornecedor_valido():
    ...
    fornecedor = Fornecedor(213, "Leandro", "8922 - 4002", "leandro@gmail.com", endereco_fornecedor, "12.345.678/000", "SEFAZ", "Caixas")
    print(fornecedor)

def advogado_valido():
    limpar()
    endereco_advogado = Endereco("Rua Augusta", "1508", "3º Andar", "01304-001", "São Paulo", UnidadeFederativa.SAO_PAULO)
    advogado = Advogado(312, "Leandro", "71 98842 - 6370", "leandro@gmail.com", endereco_advogado, Sexo.MASCULINO, EstadoCivil.SOLTEIRO, "23/03/1984", "025.887.035.45", "12.345.678-9", "321123_M", Setor.JURIDICO, 3200.00, "3309_OAB")
    print(advogado)
